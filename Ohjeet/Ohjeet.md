...
Tervetuloa! Tämä ohje kertoo, miten komentoriviharjoitukset tehdään ja miten ajat harjoitusohjelman.
...
Ohjelma näyttää aluksi kattavan aloitusohjeistuksen ja antaa sitten tehtäviä yksi kerrallaan. Kirjoita Linux-komento, joka tuottaa halutun lopputuloksen — ohjelma vertaa komentosi tulostusta oikeaan vastaukseen. Samaan lopputulokseen voi päästä monella eri komennolla.
