...
def turvallinen_komento(cmd: str) -> bool:
    ...
    Sallitaan putkitetut komennot (esim. "grep ... | wc -l"). Putkien
...
def print_intro() -> None:
    ...
    print("""
================================================================
  TERVETULOA — Linux CLI: grep-harjoitus
================================================================

Mitä tämä on?
  Tämä on Laurea AMK:n Linux-kurssin harjoitus, jossa opit
  käyttämään komentoriviä ja etenkin grep-komentoa. Tehtäviä
...
Sallitut komennot:
  grep, wc, sort, uniq, head, tail, cat
  (voit myös putkittaa niitä, esim. `grep ... | wc -l`)

Data-tiedostot (kansio `data/`):
  - asiakastiedot.txt  — nimiä, puhelimia, hetuja, IP:tä, sähköposteja
  - kirja.txt          — romaaniteksti sanahakuihin
